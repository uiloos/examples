...
import snow from "$lib/images/snow.jpg";
import barn from "$lib/images/barn.jpg";
import hawk from "$lib/images/hawk.jpg";
import burrowing from "$lib/images/burrowing.jpg";
import tawny from "$lib/images/tawny.jpg";
