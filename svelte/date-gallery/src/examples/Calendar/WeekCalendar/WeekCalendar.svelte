<div class="calendar-week" >
  <div class="calendar-week-grid" style="--height: {HEIGHT}">
    <HourIndicators />
    <DayNames dateGallery={dateGallery} />

    {#each dateGallery.firstFrame.dates.map(processDates) as {dateObj, eventColumns}, index (dateObj.date.toISOString())}
      <DayGrid
...
<script lang="ts">
  ...
  import DayNames from "./components/DayNames.svelte";
  import DayGrid from "./components/DayGrid.svelte";
  import WeekEvent from "./components/WeekEvent.svelte";
