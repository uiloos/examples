<script lang="ts">
  import { createTypewriterFromSentencesStore } from '@uiloos/svelte';

  let typewriter = createTypewriterFromSentencesStore({
    sentences: [
...
<div id="sentences-typewriter">
  {$typewriter.text}
  <span
    id="sentences-typewriter-cursor"
    class:blinking={$typewriter.cursors[0].isBlinking}
  />
</div>
