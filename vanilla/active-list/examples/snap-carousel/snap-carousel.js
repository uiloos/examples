...
const snapCarouselEl = document.getElementById("snap-carousel");
// Get a reference to the progress element
const snapProgressEl = document.getElementById("snap-carousel-progress");
...
const snapCarousel = new window.uiloosActiveList.ActiveList(
  {
    // The slides will be the contents of the ActiveList
    contents: Array.from(snapCarouselEl.querySelectorAll(".slide")),
    activeIndexes: [0],
  ...
  new window.uiloosActiveList.createActiveListSubscriber({
    ...
    onActivated(event, carousel) {
      ...
      snapCarouselEl.parentElement.insertBefore(snapProgressEl, snapCarouselEl);
