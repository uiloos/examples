...
const messageEl = document.getElementById("datepickerMessage");
...
document.getElementById("birthdayForm").onsubmit = (e) => {
  ...
  messageEl.textContent = `Your birthday is: ${formData.get("birthday")} your appointment is on ${formData.get("appointment")}`;
};

// Clear message first when submit button is clicked
// prevents old message from showing when form became
// invalid later.
document.querySelector("#birthdayForm button[type='submit']").onclick = () => {
