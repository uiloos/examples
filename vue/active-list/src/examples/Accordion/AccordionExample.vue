<template>
  ...
  <div class="description">
    ...
    <p>
      "uiloos" enhances the elements by only allowing one "details" to be open
      at a single time.
    </p>

    <p>
      In the future you will not need "uiloos" to do this for you, as a "name"
      attribute on the "details" element is going to be introduced. When more
      than one "details" share the same "name" attribute only one item is
      allowed to be opened at the same time.
    </p>

    <p>
      When it has been released you should only use "uiloos" for this usecase if
